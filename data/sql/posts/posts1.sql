INSERT INTO post (title, subtitle, content, author, author_url, publish_date, image_url, featured, card_url) VALUES 
('The Road Ahead', 'The road ahead might be paved - it might not be.', 'Dark spruce forest frowned on either side the frozen waterway. 
    ...
    adventure, pitting themselves against the might of a world as remote and
     alien and pulseless as the abysses of space.', 'Mat Vogels', 'http://localhost:8001/static/images/img_home/Cards/IMAGEMen1.png', '1443139200', 'http://localhost:8001/static/images/img_home/TheRoadAhead.png', 1, 'http://localhost:8001/static/images/img_home/TheRoadAhead.png'),
('From Top Down', 'Once a year, go someplace you’ve never been before.', 'Dark spruce forest frowned on either side the frozen waterway. 
    The trees had been stripped by a recent wind of their white 
    covering of frost, and they seemed to lean towards each other, 
    black and ominous, in the fading light. A vast silence reigned 
    over the land. The land itself was a desolation, lifeless, 
    ...
    desolation and mockery and silence, puny adventurers bent on colossal 
    adventure, pitting themselves against the might of a world as remote and
     alien and pulseless as the abysses of space.', 'William Wong', 'http://localhost:8001/static/images/img_home/Cards/IMAGEMen2.png', '1443139200', 'http://localhost:8001/static/images/img_home/FromTopDown.png', 1, 'http://localhost:8001/static/images/img_home/FromTopDown.png'),
('Still Standing Tall', 'Life begins at the end of your comfort zone.', '?', 'William Wong', 'http://localhost:8001/static/images/img_home/Cards/IMAGEMen2.png', '1443139200', 'http://localhost:8001/static/images/img_home/Cards/IMAGE1.png', 0, 'http://localhost:8001/static/images/img_home/Cards/IMAGE1.png'),
('Sunny Side Up', 'No place is ever as bad as they tell you it’s going to be.', '?', 'Mat Vogels', 'http://localhost:8001/static/images/img_home/Cards/IMAGEMen1.png', '1443139200', 'http://localhost:8001/static/images/img_home/Cards/IMAGE2.png', 0, 'http://localhost:8001/static/images/img_home/Cards/IMAGE2.png'),
('Water Falls', 'We travel not to escape life, but for life not to escape us.', '?', 'Mat Vogels', 'http://localhost:8001/static/images/img_home/Cards/IMAGEMen1.png', '1443139200', 'http://localhost:8001/static/images/img_home/Cards/IMAGE3.png', 0, 'http://localhost:8001/static/images/img_home/Cards/IMAGE3.png'),
('Through the Mist', 'Travel makes you see what a tiny place you occupy in the world.', '?', 'William Wong', 'http://localhost:8001/static/images/img_home/Cards/IMAGEMen2.png', '1443139200', 'http://localhost:8001/static/images/img_home/Cards/IMAGE4.png', 0, 'http://localhost:8001/static/images/img_home/Cards/IMAGE4.png'),
('Awaken Early', 'Not all those who wander are lost.', '?', 'Mat Vogels', 'http://localhost:8001/static/images/img_home/Cards/IMAGEMen1.png', '1443139200', 'http://localhost:8001/static/images/img_home/Cards/IMAGE5.png', 0, 'http://localhost:8001/static/images/img_home/Cards/IMAGE5.png'),
('Try it Always', 'The world is a book, and those who do not travel read only one page.', '?', 'Mat Vogels', 'http://localhost:8001/static/images/img_home/Cards/IMAGEMen1.png', '1443139200', 'http://localhost:8001/static/images/img_home/Cards/IMAGE6.png', 0, 'http://localhost:8001/static/images/img_home/Cards/IMAGE6.png');post